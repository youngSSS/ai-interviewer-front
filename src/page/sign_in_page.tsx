...
export default function SignIn() {
  ...
  const handleGoogleLogin = () => {
      window.location.href = `${GOOGLE_SIGN_IN_URI}?client_id=${GOOGLE_CLIENT_ID}&redirect_uri=${encodeURIComponent(GOOGLE_REDIRECT_URI)}&response_type=code&scope=profile%20email&state=${selectedOption}`;
  };
          ...
          <Box component="form" noValidate sx={{mt: 1}}>
            <FormControl>
              ...
              >
                <FormControlLabel
                  value="individual"
                  control={<Radio size="small" checked={selectedOption === 'individual'}/>}
                  label="individual"
                />
                <FormControlLabel
                  value="enterprise"
